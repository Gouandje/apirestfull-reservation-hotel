...
if (!defined('K_PATH_IMAGES')) {
	// $tcpdf_images_dirs = array(base_url() . 'upload/', K_PATH_MAIN);
	$tcpdf_images_dirs = array('', K_PATH_MAIN);

	/* $tcpdf_images_dirs = array(K_PATH_MAIN.'examples/images/', K_PATH_MAIN.'images/', '/usr/share/doc/php-tcpdf/examples/images/', '/usr/share/doc/tcpdf/examples/images/', '/usr/share/doc/php/tcpdf/examples/images/', '/var/www/tcpdf/images/', '/var/www/html/tcpdf/images/', '/usr/local/apache2/htdocs/tcpdf/images/', base_url().'upload/', K_PATH_MAIN); */
...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists('logos.JPG')) {
		$tcpdf_header_logo ='logos.JPG';
	}
...
if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'Wikea');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'Wikea hotel');
}
